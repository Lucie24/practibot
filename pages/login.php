        ...
        <?php
            ...
            if (!empty($_POST)) {
                ...
                if (!empty($_POST['nom'])){
                    ...
                    //$sql = "INSERT INTO praticien (nom, prenom, email, specialite, departement, log, mdp)
                    //VALUES ('$nom', '$prenom', '$email', '$specialite', '$departement', '$log', '$mdp');";
                    //$res = $conn->query($sql);
                    ...
                    $stmt = $conn->prepare("SELECT * FROM praticien WHERE log = :log");
